...
import { AgentType } from "../dashboard/account/page";
...
export default function AgentAccountPage({ agent }: { agent: AgentType }) {
  ...
  const handleEmailUpdate = () => {
    console.log("Update email to:", emailInput);
  };
  ...
  const handleForgotPassword = () => {
    console.log("Trigger forgot password for:", agent.email);
  };
    ...
    <Container maxWidth="lg" sx={{ my: 8 }}>
      ...
      <Box>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
          ...
          />
          <Button variant="outlined" onClick={handleEmailUpdate}>
            Update Email
          </Button>
        </Stack>
      </Box>
      ...
      <Box>
        ...
        <Box mt={2}>
          <Button color="error" onClick={handleForgotPassword}>
            Forgot Password?
          </Button>
        </Box>
      </Box>
