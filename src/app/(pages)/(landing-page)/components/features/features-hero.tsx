      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
        <Box sx={{ maxWidth: 780, mx: "auto", textAlign: "center" }}>
          ...
          >
            ...
            >
              Six subscriptions&apos; worth of software,{" "}
              <Box
                component="span"
                sx={{
                  color: "primary.main",
            ...
            >
              Follow-up from one company, your site from another, listings from
              an IDX feed, scheduling and email from two more. Here&apos;s each
              piece we replace — and how they work together once they live
